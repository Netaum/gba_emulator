...
[ I.NOP , I.LD_BC_u16 , I.LD_iBC_A,  I.INC_BC, I.INC_B,   I.DEC_B,   I.LD_B_n8,   I.RLCA, I.LD_iu16_SP, I.ADD_HL_BC, I.LD_A_iBC, I.DEC_BC, I.INC_C, I.DEC_C, I.LD_C_n8, I.RRCA,
  I.STOP, I.LD_DE_u16 , I.LD_iDE_A,  I.INC_DE, I.INC_D,   I.DEC_D,   I.LD_D_n8,   I.RLA , XXXXXXXXXXXX, XXXXXXXXXXX, XXXXXXXXXX, XXXXXXXX, I.INC_E, I.DEC_E, I.LD_E_n8, XXXXXX,
  XXXXXX, I.LD_HL_u16 , I.LD_iHLp_A, I.INC_HL, I.INC_H,   I.DEC_H,   I.LD_H_n8,   XXXXXX, XXXXXXXXXXXX, XXXXXXXXXXX, XXXXXXXXXX, XXXXXXXX, I.INC_L, I.DEC_L, I.LD_L_n8, XXXXXX,
  XXXXXX, I.LD_SP_u16 , I.LD_iHLn_A, I.INC_SP, I.INC_iHL, I.DEC_iHL, I.LD_iHL_u8, XXXXXX, XXXXXXXXXXXX, XXXXXXXXXXX, XXXXXXXXXX, XXXXXXXX, I.INC_A, I.DEC_A, I.LD_A_n8, XXXXXX
];
